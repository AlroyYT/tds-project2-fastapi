...
def use_github():
    ...
    return "https://raw.githubusercontent.com/AlroyYT/email-repo/refs/heads/main/email.json"
...
def create_a_scheduled_github_action(
    ...
    email="23f3001360@ds.study.iitm.ac.in",  # Set default to required email
    cron="30 2 * * *",                   
